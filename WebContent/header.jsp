...
<table width="90%" align="center" >
	<tr>
		<td align="right"
					...
					<b>
							<font size="5" color="#808080" face="arial">Blue Horn</font></b><br>
				...
				<td align="left"
					...
					<font color="#808080" face="arial" size="6"><b>&nbsp;Infosys</b></font>
				</td>
			</tr>
			<tr>			
				<td colspan="2" align="right"
					...
					size="2" color="#000000" >&nbsp;Welcome ${userName}| 
					<!-- <input type ="submit" name ="submit" id ="submit" value="Log Out"> -->
					<a class="logout" href= '<%=request.getContextPath()%>/Logout' >Logout</a> </font></td>
			</tr>
	</table>
	<br>
	<table width="90.5%" align="center">
			<tr bgcolor="#0000A0">
				<td>
					<ul class="topnav">
						<li><a href= 'home.jsp' style="text-decoration: none">
